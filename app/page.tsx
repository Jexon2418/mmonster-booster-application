    ...
    <div className="w-full max-w-3xl px-4">
      <div className="flex justify-center space-x-2">
        {Array.from({ length: 10 }, (_, i) => (
          <div
            key={i}
            className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-600 text-gray-300"
          ></div>
        ))}
      </div>
      <div className="mt-4 bg-[#1A202C] border border-[#E53E3E]/30 rounded-xl p-8 text-white h-96 flex items-center justify-center">
