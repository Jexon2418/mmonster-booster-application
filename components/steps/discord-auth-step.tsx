...
export function DiscordAuthStep({ onContinue, onBack }: DiscordAuthStepProps) {
  return (
    <FormSection
    ...
    >
      <Alert type="error">
        <p>
          We're experiencing technical issues with Discord authentication. You can use the bypass option below to
          continue with the application temporarily.
        </p>
      </Alert>
      ...
      <div className="mt-8 bg-[#1E2533] rounded-md p-6">
        ...
        <button
          onClick={() => {}}
          className="w-full py-3 bg-[#5865F2] text-white rounded-md hover:bg-[#5865F2]/90 transition-colors flex items-center justify-center"
        >
          <svg
            width="20"
            height="20"
