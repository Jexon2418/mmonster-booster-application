...
export function FormSection({ title, description, children }: FormSectionProps) {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-white mb-6">Booster Application</h1>
  ...
  return (
    <div className="mt-8 space-y-4">
      ...
      {onBack && (
        <button
          onClick={onBack}
          className="flex items-center justify-center w-full sm:w-auto px-6 py-3 bg-transparent border border-[#E53E3E]/30 text-[#E53E3E] rounded-md hover:bg-[#E53E3E]/10 transition-colors"
        >
          <svg
